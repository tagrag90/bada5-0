...
export default function UserPostPreview({ post }: UserPostPreviewProps) {
  ...
  return (
    <article
      className={cn(
        "group/post overflow-hidden bg-card border-2 border-gray-200 pb-4 pt-4 px-4 w-80 flex-shrink-0 rounded-xl"
      )}
    >
